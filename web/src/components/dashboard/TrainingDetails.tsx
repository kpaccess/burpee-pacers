  ...
  return (
    ...
    >
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mt: 0.75 }}>
        A 5-minute warm-up reduces injury risk. A 5-10 minute cool-down speeds
        recovery. Build the habit - it compounds over 6 months.
      </Typography>
      ...
      <Collapse in={healthSectionOpen} timeout="auto" unmountOnExit>
        <Box mt={2.5}>
          ...
          >
            <Tab
              label="Warm-up (5-8 min)"
              value="warmup"
              sx={{ fontWeight: 700, fontSize: "0.8rem" }}
            />
            <Tab
              label="Cool-down (5-10 min)"
              value="cooldown"
              sx={{ fontWeight: 700, fontSize: "0.8rem" }}
            />
          </Tabs>
      ...
      >
        <Box>
          <Typography
            variant="h6"
            fontWeight={700}
            color={pullingWorkUnlocked ? "secondary" : "text.secondary"}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box display="flex" alignItems="center" gap={1}>
          <Button size="small" onClick={onPrevMonth}>
            Prev
          </Button>
          <Typography
            variant="subtitle1"
          ...
          <Button size="small" onClick={onNextMonth}>
            Next
          </Button>
        </Box>
      </Box>
      ...
      <Box display="grid" gridTemplateColumns="repeat(7, 1fr)" gap={1}>
        {trackingDays.map((dateStr) => {
          ...
          const hasStartedProgram =
            !startDate || dateStr >= format(startDate, "yyyy-MM-dd");
          const isMissed =
            isPast && isWorkoutDay && hasStartedProgram && !isCompleted;
          ...
          return (
            ...
            >
              <Typography
                variant="body2"
                fontWeight={isCurrentMonthValue ? "bold" : "normal"}
              >
                {format(dayObj, "d")}
              </Typography>
              {isWorkoutDay || isCompleted ? (
                ...
                <Typography
                  variant="caption"
                  sx={{ mt: 1, color: "text.disabled", fontSize: "0.65rem" }}
                >
                  Rest
                </Typography>
              )}
    ...
    >
      ...
      >
        <Box display="flex" alignItems="center" gap={1.5}>
          ...
          >
            <Typography sx={{ color: "common.black", fontWeight: 900 }}>
              W
            </Typography>
          </Box>
          <Box>
